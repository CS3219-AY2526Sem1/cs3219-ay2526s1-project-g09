 ...
 * 
 * @param users               the list of user IDs to include in the
 *                            collaboration session
 * @param questionPreferences a mapping of question categories with a list of
 *                            difficulties for session creation
 */
