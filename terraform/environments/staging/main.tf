module "ui_shell_s3_and_cloudfront" {
  source = "../../modules/storage/ui-shell"
}

module "frontend_service_s3_and_cloudfront" {
  source       = "../../modules/storage/ui"
...
module "backend_service_cloudfront" {
  ...
  eb_collab_service_url = module.backend_service_elastic_beanstalk.elastic_beanstalk_collab_service_url
}

module "backend_service_elastic_beanstalk" {
...
# module "ui_shell_iam" {
#   source                               = "../../modules/iam"
#   frontend_s3_bucket_id                = aws_s3_bucket.ui_shell.id
#   frontend_s3_bucket_arn               = aws_s3_bucket.ui_shell.arn
#   frontend_cloudfront_distribution_arn = aws_cloudfront_distribution.ui_shell.arn
# }
